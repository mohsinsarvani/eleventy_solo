...
![iPad screen capture: Working Copy on the left, iA Writer on the right](/images/Working_Copy_scr_cap_01_1024x768.jpg){.lazy}
...
![iPad screen capture: Working Copy display of the local Git repository on the device](/images/Working_Copy_scr_cap_02_1024x768.jpg){.lazy}
...
![iPad screen capture: Working Copy display showing a push has gone to Bitbucket](/images/Working_Copy_scr_cap_04_1024x768.jpg){.lazy}
...
![iPad screen capture: Working Copy display showing that the master branch is synchronized with the three remote repositories](/images/Working_Copy_scr_cap_07_1024x768.jpg){.lazy}
...
![iPad screen capture: Working Copy display showing its built-in text editor](/images/Working_Copy_scr_cap_11_1024x768.jpg){.lazy}
